    ...
    <body>
        <form method="post" class="flex flex-col items-center mt-10">
            <div class="flex flex-col">
                ...
                <input class="border-2 rounded text-lg pl-1 placeholder:text-base" type="text" name="username" placeholder="Enter a username" required>
            </div>

            <div class="flex flex-col mt-3">
                <label class="text-lg" for="password">Password</label>
                <input class="border-2 rounded text-lg pl-1 placeholder:text-base" type="password" name="password" placeholder="Enter a password" required>
            </div>
        ...
        <form method="post" class="flex flex-col items-center mt-10">
            ...
            <div class="flex flex-col mt-3">
                ...
                <input class="border-2 rounded text-lg pl-1 placeholder:text-base" type="password" name="passwordConfirm" placeholder="Enter a password" required>
            </div>
