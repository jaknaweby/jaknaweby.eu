<div>
    ...
    <x-secondary-button onclick="exec('u', '{{ $id }}')" class="mt-2 !bg-amber-500 hover:!bg-amber-600 !text-white border-0 focus:!ring-0 focus:!ring-offset-0">
        Underline
    </x-secondary-button>
</div>

<script>
    function exec(action, id) {
