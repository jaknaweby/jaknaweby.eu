...
@section('content')
    ...
    <div class="w-full bg-red-500 px-20 py-10 text-white">
    ...
    <div class="w-full bg-blue-500 px-20 py-10 text-white">
    ...
    <div class="w-full bg-amber-500 px-20 py-10 text-white">
    ...
    <div class="w-full bg-indigo-500 px-20 py-10 text-white">
    ...
    <div class="w-full bg-orange-500 px-20 py-10 text-white">
